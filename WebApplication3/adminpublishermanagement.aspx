            ...
            <div style="width: 800px;margin:auto;">
                    ...
                    <div class="card-body">
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                <div class="input-group">
                                    ...
                                    <asp:Button class="form-control btn btn-primary" ID="Button1" runat="server"  Text=">>" OnClick="Button1_Click" />
                                </div>
                            </div>
                        </div>
                        </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    <asp:TextBox CssClass="form-control" ID="TextBox2" runat="server" Width="200px" placeholder="Publisher Name"></asp:TextBox>
                                </div>
                            </div>
                        </div>
                        <br />
                        ...
                        <div class="row">
                            ...
                            <asp:Button ID="Button4" class="btn btn-lg btn-block btn-primary" runat="server" Text="Delete" OnClick="Button4_Click" />
                        </div>
